...
class RuntimeOverview(QFrame):
    ...
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        header_row.addWidget(self.state_dot)
        ...
        metrics_group = QFrame(self)
        metrics_group.setObjectName("metricsGroup")
        stats = QGridLayout(metrics_group)
        stats.setContentsMargins(12, 12, 12, 12)
        stats.setHorizontalSpacing(16)
        stats.setVerticalSpacing(12)
        stats.addWidget(self.completed_value[0], 0, 0)
        stats.addWidget(self.active_value[0], 0, 1)
        stats.addWidget(self.elapsed_value[0], 1, 0)
        stats.addWidget(self.remaining_value[0], 1, 1)
        stats.addWidget(self.estimated_value[0], 2, 0)
        stats.addWidget(self.platform_value[0], 2, 1)
    ...
    @staticmethod
    def _stat(value: str, label: str) -> tuple[QFrame, QLabel]:
        cell = QFrame()
        cell.setObjectName("metricCell")
        value_label = QLabel(value, cell)
        value_label.setObjectName("sectionTitle")
        value_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        text_label = QLabel(label, cell)
